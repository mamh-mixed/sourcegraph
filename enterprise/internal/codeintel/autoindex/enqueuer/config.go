...
func (c *Config) Load() {
	...
	c.MaximumIndexJobsPerInferredConfiguration = c.GetInt("PRECISE_CODE_INTEL_AUTO_INDEX_MAXIMUM_INDEX_JOBS_PER_INFERRED_CONFIGURATION", "100", "Repositories with a number of inferred auto-index jobs exceeding this threshold will be auto-indexed.")
}
