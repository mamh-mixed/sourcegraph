...
import { Container, PageSelector, RadioButton, Select, Link, Checkbox, Typography } from '@sourcegraph/wildcard'
        ...
        <>
            ...
            <div className="d-flex flex-row align-items-baseline mb-0">
                <RadioButton
                    ...
                    label={
                        <div className="d-flex flex-column ml-2">
                            <Typography.Text className="mb-0">Sync selected repositories</Typography.Text>
                        </div>
                    }
                />
            </div>
