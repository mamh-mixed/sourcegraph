        ...
        <Form className="mt-4">
                    ...
                    <RadioButton
                        ...
                        label={
                            <div className="d-flex flex-column ml-2">
                                <Typography.Text className="mb-0">Sync all repositories</Typography.Text>
                                <Typography.Text className="font-weight-normal text-muted">
            ...
            <div className="d-flex flex-row align-items-baseline mb-0">
                <RadioButton
                    ...
                    label={
                        <div className="d-flex flex-column ml-2">
                            <Typography.Text className={classNames('mb-0', !hasCodeHosts && styles.textDisabled)}>
    ...
    const filterControls: JSX.Element = (
        <Form onSubmit={preventSubmit} className="w-100 d-inline-flex justify-content-between flex-row mt-3">
            <div className="d-inline-flex flex-row mr-3 align-items-baseline">
                <Typography.Text className="text-xl-center text-nowrap mr-2">Code Host:</Typography.Text>
                <Select
                    name="code-host"
                    ...
                    {window.context.sourcegraphDotComMode && !isOrgOwner && (
                        <ListItemContainer key="add-textarea">
                            <div>
                                ...
                                <Typography.Text className="text-muted">
                                    Public repositories on GitHub and GitLab
                                </Typography.Text>
                                <Checkbox
                                    id="add-public-repos"
                                    className="mr-2 mt-2"
                                ...
                                {publicRepoState.enabled && (
                                    <div className="form-group ml-4 mt-3">
                                        <Typography.Text className="mb-2">Repositories to sync</Typography.Text>
                                        <TextArea
                                            rows={5}
