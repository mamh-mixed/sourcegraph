...
import { PageHeader, AlertLink, useTimeoutManager, Alert, Icon, Typography } from '@sourcegraph/wildcard'
                        ...
                        <PageHeader
                            ...
                            description={
                                ...
                                (manifest.description || isWorkInProgress) && (
                                    <Typography.Text className="mt-1 mb-0">{manifest.description}</Typography.Text>
                                )
                            }
                            actions={
