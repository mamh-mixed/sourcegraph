...
import { Button, Link, LoadingSpinner, Alert, Typography } from '@sourcegraph/wildcard'
    ...
    public render(): JSX.Element | null {
        if (this.state.submitOrError === null) {
            return (
                <>
                    ...
                    >
                        <Typography.Text alignment="left" className="mb-0">
        ...
        return (
            <>
                ...
                >
                    <Typography.Text alignment="left">
    ...
    public render(): JSX.Element | null {
        ...
        return (
            <>
                ...
                >
                    <Typography.Text alignment="left">Enter a new password for your account.</Typography.Text>
                    <div className="form-group">
                        <PasswordInput
                            name="password"
