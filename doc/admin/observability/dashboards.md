...
To see this panel, visit `/-/debug/grafana/d/frontend/frontend?viewPanel=101921` on your Sourcegraph instance.
...
To see this panel, visit `/-/debug/grafana/d/frontend/frontend?viewPanel=102012` on your Sourcegraph instance.
...
To see this panel, visit `/-/debug/grafana/d/frontend/frontend?viewPanel=102022` on your Sourcegraph instance.
...
To see this panel, visit `/-/debug/grafana/d/frontend/frontend?viewPanel=102031` on your Sourcegraph instance.
...
To see this panel, visit `/-/debug/grafana/d/frontend/frontend?viewPanel=102112` on your Sourcegraph instance.
...
To see this panel, visit `/-/debug/grafana/d/frontend/frontend?viewPanel=102151` on your Sourcegraph instance.
...
To see this panel, visit `/-/debug/grafana/d/frontend/frontend?viewPanel=102152` on your Sourcegraph instance.
...
To see this panel, visit `/-/debug/grafana/d/frontend/frontend?viewPanel=102403` on your Sourcegraph instance.
...
To see this panel, visit `/-/debug/grafana/d/frontend/frontend?viewPanel=102970` on your Sourcegraph instance.
...
### Worker: Record encrypter

#### worker: records_encrypted_total

<p class="subtitle">TODO 1 records encrypted every 5m</p>

Number of encrypted records every 5m
...
<p class="subtitle">TODO 2 records decrypted every 5m</p>
...
<p class="subtitle">TODO 3 operation errors every 5m</p>

Number of record encryption/decryption errors every 5m
...
To see this panel, visit `/-/debug/grafana/d/worker/worker?viewPanel=102003` on your Sourcegraph instance.
...
To see this panel, visit `/-/debug/grafana/d/worker/worker?viewPanel=103020` on your Sourcegraph instance.
...
To see this panel, visit `/-/debug/grafana/d/worker/worker?viewPanel=103030` on your Sourcegraph instance.
...
To see this panel, visit `/-/debug/grafana/d/worker/worker?viewPanel=103031` on your Sourcegraph instance.
...
To see this panel, visit `/-/debug/grafana/d/worker/worker?viewPanel=103032` on your Sourcegraph instance.
...
To see this panel, visit `/-/debug/grafana/d/worker/worker?viewPanel=103102` on your Sourcegraph instance.
...
To see this panel, visit `/-/debug/grafana/d/worker/worker?viewPanel=103103` on your Sourcegraph instance.
...
To see this panel, visit `/-/debug/grafana/d/worker/worker?viewPanel=103210` on your Sourcegraph instance.
...
To see this panel, visit `/-/debug/grafana/d/worker/worker?viewPanel=103211` on your Sourcegraph instance.
...
To see this panel, visit `/-/debug/grafana/d/worker/worker?viewPanel=103212` on your Sourcegraph instance.
...
To see this panel, visit `/-/debug/grafana/d/worker/worker?viewPanel=103301` on your Sourcegraph instance.
...
To see this panel, visit `/-/debug/grafana/d/codeintel-autoindexing/codeintel-autoindexing?viewPanel=100002` on your Sourcegraph instance.
...
To see this panel, visit `/-/debug/grafana/d/codeintel-autoindexing/codeintel-autoindexing?viewPanel=100003` on your Sourcegraph instance.
...
To see this panel, visit `/-/debug/grafana/d/codeintel-autoindexing/codeintel-autoindexing?viewPanel=100013` on your Sourcegraph instance.
