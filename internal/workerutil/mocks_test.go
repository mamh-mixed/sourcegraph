...
// unit testing.
type MockHandler[T workerutil.Record] struct {
...
func NewMockHandler[T workerutil.Record]() *MockHandler[T] {
...
func NewStrictMockHandler[T workerutil.Record]() *MockHandler[T] {
	return &MockHandler[T]{
		HandleFunc: &HandlerHandleFunc[T]{
...
func NewMockHandlerFrom[T workerutil.Record](i Handler[T]) *MockHandler[T] {
	return &MockHandler[T]{
		HandleFunc: &HandlerHandleFunc[T]{
...
type HandlerHandleFunc[T workerutil.Record] struct {
	defaultHook func(context.Context, log.Logger, T) error
...
type HandlerHandleFuncCall[T workerutil.Record] struct {
...
// methods delegate to the given implementation, unless overwritten.
func NewMockStoreFrom[T workerutil.Record](i Store[T]) *MockStore[T] {
	return &MockStore[T]{
		AddExecutionLogEntryFunc: &StoreAddExecutionLogEntryFunc[T]{
...
func (m *MockStore[T]) CanceledJobs(v0 context.Context, v1 []int) ([]int, error) {
	r0, r1 := m.CanceledJobsFunc.nextHook()(v0, v1)
	m.CanceledJobsFunc.appendCall(StoreCanceledJobsFuncCall[T]{v0, v1, r0, r1})
	return r0, r1
}

// SetDefaultHook sets function that is called when the CanceledJobs method
// of the parent MockStore instance is invoked and the hook queue is empty.
func (f *StoreCanceledJobsFunc[T]) SetDefaultHook(hook func(context.Context, []int) ([]int, error)) {
	f.defaultHook = hook
}
...
func (f *StoreCanceledJobsFunc[T]) PushHook(hook func(context.Context, []int) ([]int, error)) {
	f.mutex.Lock()
	f.hooks = append(f.hooks, hook)
	f.mutex.Unlock()
}
...
func (f *StoreCanceledJobsFunc[T]) nextHook() func(context.Context, []int) ([]int, error) {
	f.mutex.Lock()
	defer f.mutex.Unlock()
...
// parameter and result values of this invocation.
func (m *MockStore[T]) Heartbeat(v0 context.Context, v1 []int) ([]int, error) {
	r0, r1 := m.HeartbeatFunc.nextHook()(v0, v1)
	m.HeartbeatFunc.appendCall(StoreHeartbeatFuncCall[T]{v0, v1, r0, r1})
	return r0, r1
}

// SetDefaultHook sets function that is called when the Heartbeat method of
// the parent MockStore instance is invoked and the hook queue is empty.
func (f *StoreHeartbeatFunc[T]) SetDefaultHook(hook func(context.Context, []int) ([]int, error)) {
	f.defaultHook = hook
}
...
// front of the queue and discards it. After the queue is empty, the default
// hook function is invoked for any future action.
func (f *StoreHeartbeatFunc[T]) PushHook(hook func(context.Context, []int) ([]int, error)) {
	f.mutex.Lock()
	f.hooks = append(f.hooks, hook)
	f.mutex.Unlock()
}
...
func (f *StoreHeartbeatFunc[T]) nextHook() func(context.Context, []int) ([]int, error) {
	f.mutex.Lock()
	defer f.mutex.Unlock()
...
// for unit testing.
type MockWithHooks[T workerutil.Record] struct {
...
func NewMockWithHooks[T workerutil.Record]() *MockWithHooks[T] {
...
// methods panic on invocation, unless overwritten.
func NewStrictMockWithHooks[T workerutil.Record]() *MockWithHooks[T] {
	return &MockWithHooks[T]{
		PostHandleFunc: &WithHooksPostHandleFunc[T]{
			defaultHook: func(context.Context, log.Logger, T) {
...
func NewMockWithHooksFrom[T workerutil.Record](i WithHooks[T]) *MockWithHooks[T] {
	return &MockWithHooks[T]{
		PostHandleFunc: &WithHooksPostHandleFunc[T]{
...
type WithHooksPostHandleFunc[T workerutil.Record] struct {
	defaultHook func(context.Context, log.Logger, T)
...
type WithHooksPostHandleFuncCall[T workerutil.Record] struct {
	// Arg0 is the value of the 1st argument passed to this method
	// invocation.
	Arg0 context.Context
	// Arg1 is the value of the 2nd argument passed to this method
...
// of the parent MockWithHooks instance is invoked.
type WithHooksPreHandleFunc[T workerutil.Record] struct {
	defaultHook func(context.Context, log.Logger, T)
	hooks       []func(context.Context, log.Logger, T)
...
type WithHooksPreHandleFuncCall[T workerutil.Record] struct {
	// Arg0 is the value of the 1st argument passed to this method
	// invocation.
	Arg0 context.Context
	// Arg1 is the value of the 2nd argument passed to this method
