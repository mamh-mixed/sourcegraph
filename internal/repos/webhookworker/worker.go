...
func NewWorker(ctx context.Context, handler workerutil.Handler[*Job], workerStore workerstore.Store[*Job], metrics workerutil.WorkerMetrics) *workerutil.Worker[*Job] {
